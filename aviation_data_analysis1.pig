****** Use commands to execute some problems to analysis the data from the Commands folder...*******


****** Setup the Bigdata system and load the require files by follow the steps...*******
